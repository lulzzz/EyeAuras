...
// ReSharper disable SuggestUseVarKeywordEvident
            ...
            IDictionary<string, object>
    {
        ...
        ///     <see cref="T:System.Dynamic.DynamicObject" /> class, <paramref name="indexes" /> is equal to 3.
        /// </param>
        /// <param name="value">
...
// that might be in place in the target project.
        ...
        class ReflectionUtils
    {
        ...
        public static GetDelegate GetGetMethodByExpression(PropertyInfo propertyInfo)
        {
            ...
            var compiled = Expression.Lambda<Func<object, object>>(Expression.TypeAs(Expression.Call(instanceCast, getMethodInfo), typeof(object)), instance)
                .Compile();
